...
exports.SOLAR_TERM_DEGREES = exports.TERMS_LONGITUDE = void 0;
exports.dateToJD = dateToJD;
exports.jdToDate = jdToDate;
exports.getSolarTermDate = getSolarTermDate;
exports.TERMS_LONGITUDE = [
...
function getSolarTermDate(year, targetDeg) {
    // Approximate date:
    // Ipchun (315) ~ Feb 4.
    // Chunbun (0) ~ Mar 20.
